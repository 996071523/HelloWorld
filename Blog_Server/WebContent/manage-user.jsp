...
<% 	
	//判断是否有用户数据列表显示出来，若没有，则跳转到user.s?op=query进行查询显示
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        ...
        <form action="user.s">
        	...
        	用户名：<input name="account" value="${params.account }">
        	姓名：<input name="name" value="${params.name }">      
        	电话：<input name="tel" value="${params.tel }">
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <form action="user.s?op=add" method="post" autocomplete="off" draggable="false">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
            <!-- 使用el表达式实现参数回填，避免信息填写错误后清空需要全部重新填写，更便捷 -->
              <tr>
                <td wdith="20%">用户名:</td>
